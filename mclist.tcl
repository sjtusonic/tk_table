...
ttk::label $w.msg -font $font -wraplength 4i -justify left -anchor n -padding {10 2 10 6} -text "this is a table GUI of tk"
pack $w.msg -fill x
...
ttk::treeview $w.tree -columns {Col1 Col2 Col3} -show headings \
    -yscroll "$w.vsb set" -xscroll "$w.hsb set"
#$w.tree config -columns {Col1 Col2 Col3}
...
for {set i 0} {$i <= 6000} {incr i} {
    #set ll [list a$i b$i c$i]
    set ll [list 1 2 3]
    #set ll [list a b c]
    #lappend data $ll
    foreach j $ll {
       lappend data [expr rand()*$j]
    }
}

$w.msg config -text "data has [llength $data] lines:"
## Code to insert the data nicely
set font [ttk::style lookup Heading -font]
foreach col {Col1 Col2 Col3} name {Col1 Col2 Col3} {
...
foreach {Col1 Col2 Col3} $data {
    $w.tree insert {} end -values [list $Col1 $Col2 $Col3]
